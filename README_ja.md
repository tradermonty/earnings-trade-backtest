...
├── earnings_backtest.py           # メインバックテストコード
├── requirements.txt               # Python依存関係
├── CLAUDE.md                     # Claude向けドキュメント
├── README.md                     # このファイル
├── .gitignore                    # Git除外設定
├── articles/                     # 分析記事・ドキュメント
│   ├── blog_article_earnings_trade_backtest_2025_first_half.md
│   ├── article_evaluation.md
│   ├── blog_checklist.md
│   └── final_checklist_results.md
...
└── earnings_backtest_2025-01-01_2025-06-30_mid-small-only.csv  # フィルター済みデータ
```
...
- [分析記事テンプレート](articles/)
- [品質チェックリスト](articles/blog_checklist.md)
